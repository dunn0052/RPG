...
def touchDirection(sprite1, sprite2):
    if touching(sprite1, sprite2):
        l1 = sprite1.rect.left
        r1 = sprite1.rect.right
        t1 = sprite1.rect.top
        b1 = sprite1.rect.bottom
        l2 = sprite2.rect.left
        r2 = sprite2.rect.right
        t2 = sprite2.rect.top
        b2 = sprite2.rect.bottom
        if l1 < r2 and t1 < b2 and b1 > t2:
            return "left"
        elif l1 > c2:
            return "right"
        elif l1 < 0:
